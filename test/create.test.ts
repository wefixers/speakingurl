...
describe('getSlug create', () => {
  ...
  it('with custom string replacement', () => {
    ...
    expect(getSlug('bus and train bus and train')).toBe('bus-und-train-bus-und-train')
    expect(getSlug('bus or train bus or train')).toBe('bus-oder-train-bus-oder-train')
